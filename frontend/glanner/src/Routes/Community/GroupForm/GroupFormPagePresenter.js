...
import { Box, Button, Divider, TextField, Grid, Typography, CardMedia, ImageListItem, ImageListItemBar, IconButton, Autocomplete, Stack, Chip } from "@mui/material";
...
export const GroupFormPagePresenter = ({
  ...
  return (
      <form noValidate onSubmit={(e) => e.preventDefault()} style={{ padding: '40px 60px 40px 80px'}}>            
        <Grid container>          
          <Grid item xs={1.2}>

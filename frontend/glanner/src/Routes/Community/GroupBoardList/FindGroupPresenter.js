...
export default function FindGroupPresenter({
  ...
  return (
    <>
      ...
      {groupBoardList && (
        <Box sx={{ mt: 2, fontFamily: "Noto Sans KR" }}>
          <Box
            component="form"
            noValidate
            autoComplete="off"
          ...
          >
            <FormGroup
              sx={{ ml: 95, width: "25ch", mb: 1, mt: 3, height: 50 }}
              size="small"
            >
              ...
              <OutlinedInput
                ...
                startAdornment={
                  ...
                  >
                    <MenuItem sx={{ fontSize: 13 }} value={"search"}>
                      제목 + 내용
                    </MenuItem>
                    <MenuItem sx={{ fontSize: 13 }} value={"interest"}>
                      관심사
                    </MenuItem>
                  </Select>
                }
          ...
          <Box
            ...
            sx={{ textAlign: "left", height: "500px", px: 15 }}
          >
                  ...
                  <Grid item xs={6} key={boardId}>
                    <Paper sx={{ px: 3, py: 2, height: "auto" }}>
                      ...
                      >
                        <Grid
                          item
                          onClick={() => navigator(`/board/group/${boardId}`)}
                          sx={{ cursor: "pointer" }}
                        >
                          <Grid
                            container
                          ...
                          >
                            ...
                            <Typography sx={{ color: "#959595", fontSize: 15, fontFamily: "Noto Sans KR", }}>
                          ...
                          <Typography
                            className="membernum"
                            variant="body2"
                            sx={{ mb: 1, fontFamily: "Noto Sans KR",}}
                          >
                            {/* <UserFriend
                          style={{
                            color: "#5F5F5F",
                        ...
                        />  */}
                            ...
                            <Box component="span" sx={{ ml: 1, fontSize: 20, fontFamily: "Noto Sans KR", }}>
                              {present} / 5
                            </Box>
                          </Typography>
                          <Typography
                        ...
                        >
                          <Box>
                            ...
                            <Typography
                              className="nickName"
                              sx={{ fontSize: 20, cursor: "pointer", mx: 0.5, fontFamily: "Noto Sans KR", }}
                              component="span"
                            >
                              {userName}
                            </Typography>
                          ...
                          <Box sx={{ color: "#808080" }}>
                            <Typography component="span" sx={{ mx: 1, fontFamily: "Noto Sans KR", }}>
                              <VisibilityOutlinedIcon
                                sx={{ transform: "scale(0.7)" }}
                              />
                              {count}
                            </Typography>
                            <Typography component="span" sx={{fontFamily: "Noto Sans KR",}}>

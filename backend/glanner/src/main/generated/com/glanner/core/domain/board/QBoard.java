...
public class QBoard extends BeanPath<Board> {
    ...
    public final ListPath<FileInfo, QFileInfo> fileInfos = this.<FileInfo, QFileInfo>createList("fileInfos", FileInfo.class, QFileInfo.class, PathInits.DIRECT2);
